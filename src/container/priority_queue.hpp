...
namespace mrsuyi {
template <class T,
          class Container = mrsuyi::vector<T>,
...
class priority_queue {
 public:
  ...
  priority_queue(
      const Alloc&,
      typename std::enable_if<!uses_allocator<Container, Alloc>::value>::type* =
          0);
  template <class Alloc>
  priority_queue(
      const Compare&,
  ...
  priority_queue(InputIt first, InputIt last, const Compare&, const Container&);
  template <class InputIt>
  priority_queue(InputIt first,
                 InputIt last,
...
// =
template <class T, class Container, class Compare>
priority_queue<T, Container, Compare>& priority_queue<T, Container, Compare>::
operator=(const priority_queue& other) {
  priority_queue(other).swap(*this);
}
template <class T, class Container, class Compare>
priority_queue<T, Container, Compare>& priority_queue<T, Container, Compare>::
operator=(priority_queue&& other) {
